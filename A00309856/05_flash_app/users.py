...
from users_commands import get_all_users, add_user, remove_user,recently_logged,history_users
...
def history_users(username):
	
  	list = {}
  	list =history_users(username);
  	return json.dumps (list),200
